...
const Checkout = ({ cartList, setCartList, setCheckout,setOpen,setMessage }) => {
            ...
            <Grid container spacing={4}>
              <Grid item xs={12} sm container>
                <Grid item xs container direction="column" spacing={2}>
                  <Grid item xs>
                    <p style={{ color:"#343A40" ,fontSize: "28px", fontWeight: "bold" ,margin:"auto" ,display:"flex",justifyContent:"center"}}>
                      Checkout
                    </p>
                    <div style={{ margin: "16px" }}>
                      ...
                      <div>
                        Mobile Number :{sessionStorage.getItem("phone")}
                      </div>
                    </div>
